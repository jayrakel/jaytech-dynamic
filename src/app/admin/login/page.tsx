...
function LoginForm() {
  ...
  return (
    <div
      ...
      style={{
        backgroundImage: "linear-gradient(rgba(20,184,166,.03) 1px,transparent 1px),linear-gradient(90deg,rgba(20,184,166,.03) 1px,transparent 1px)",
    ...
    >
      <div className="w-full max-w-sm">
        ...
        <div className="p-8 card-dark rounded-2xl">
          {error && (
            <div className="mb-4 p-3 bg-red-400/10 border border-red-400/30 rounded-xl text-red-400 text-sm">{error}</div>
          )}
          <form onSubmit={submit} className="space-y-4">
            <div>
              ...
              <input
                required
                type="email"
                className="w-full px-4 py-3 bg-slate-900 border border-slate-700 rounded-xl text-white text-sm focus:outline-none focus:border-teal-500 transition-all"
                placeholder="admin@jaytechwavesolutions.com"
                value={form.email}
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full grad-bg text-white font-heading font-bold py-3.5 rounded-xl hover:opacity-90 transition-all disabled:opacity-50 mt-2"
            >
